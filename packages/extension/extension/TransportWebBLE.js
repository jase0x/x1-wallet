...
import { t as trace, l as log, T as Transport, g as getBluetoothServiceUuids, b as getInfosForServiceUuid } from "./index2.js";
import { a as TransportError, b as DisconnectedDevice, T as TransportOpenUserCancelled } from "./index3.js";
import { _ as __values, a as __spreadArray, b as __read, c as __extends, d as __asyncGenerator, e as __generator, f as __await, g as __awaiter, h as __asyncValues } from "./tslib.es6.js";
import "./popup.js";
import "./events.js";
...
class BluetoothTransport extends Transport {
  constructor(device, writeCharacteristic, notifyObservable, deviceModel) {
    ...
    __publicField(this, "mtuSize", 20);
    __publicField(this, "writeCharacteristic");
    __publicField(this, "notifyObservable");
    __publicField(this, "notYetDisconnected", true);
    __publicField(this, "deviceModel");
    __publicField(this, "write", async (buffer) => {
...
__publicField(BluetoothTransport, "isSupported", () => Promise.resolve().then(requiresBluetooth).then(() => true, () => false));
/**
 * observe event with { available: bool, type: string }
 * (available is generic, type is specific)
 * an event is emit once and then each time it changes
 */
__publicField(BluetoothTransport, "observeAvailability", (observer) => availability().subscribe(observer));
__publicField(BluetoothTransport, "list", () => Promise.resolve([]));
/**
 * globally disconnect a bluetooth device by its id.
 */
__publicField(BluetoothTransport, "disconnect", async (id) => {
